...
use adk_anthropic::{
    ...
    MessageStartEvent, MessageStreamEvent, Model, OutputConfig, StopReason, SystemPrompt,
    TextBlock, ThinkingConfig, ThinkingDisplay, ToolParam, ToolResultBlock, ToolResultBlockContent,
...
use super::model_gateway::{
    BoundedSseEvent, MAX_EXECUTION_ID_BYTES, ModelGatewayClient, ModelGatewayError,
    ModelGatewayInvocation, ModelReasoningEffort, SseParser, bounded_header_text, model_error,
...
// `model_gateway::EXECUTION_ID_HEADER` (canonical form
