...
- [Legacy toolkit names](source-mapping/toolkit-name-compatibility-20260924.md) pass 51 pipeline tests and deployed direct MCP browser acceptance in chat 683. Exact names take precedence; ambiguous compatibility matches fail before connection. Live collision and LLM-loop compatibility acceptance remain open.
