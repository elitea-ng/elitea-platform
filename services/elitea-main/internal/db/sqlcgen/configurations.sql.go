...
WHERE project_id = $1::integer
  ...
  AND (
      ...
      OR configuration.author_id = $6::integer
  )
`
...
ORDER BY
  ...
  CASE WHEN $7::text = 'asc'  AND $8::text = 'id'            THEN configuration.id END ASC,
  CASE WHEN $7::text = 'desc' AND $8::text = 'id'            THEN configuration.id END DESC,
  CASE WHEN $7::text = 'asc'  AND $8::text = 'uuid'          THEN configuration.uuid END ASC,
  CASE WHEN $7::text = 'desc' AND $8::text = 'uuid'          THEN configuration.uuid END DESC,
  CASE WHEN $7::text = 'asc'  AND $8::text = 'project_id'    THEN configuration.project_id END ASC,
  CASE WHEN $7::text = 'desc' AND $8::text = 'project_id'    THEN configuration.project_id END DESC,
  CASE WHEN $7::text = 'asc'  AND $8::text = 'label'         THEN configuration.label END ASC NULLS LAST,
  CASE WHEN $7::text = 'desc' AND $8::text = 'label'         THEN configuration.label END DESC NULLS LAST,
  CASE WHEN $7::text = 'asc'  AND $8::text = 'elitea_title'  THEN configuration.elitea_title END ASC,
  CASE WHEN $7::text = 'desc' AND $8::text = 'elitea_title'  THEN configuration.elitea_title END DESC,
  CASE WHEN $7::text = 'asc'  AND $8::text = 'type'          THEN configuration.type END ASC,
  CASE WHEN $7::text = 'desc' AND $8::text = 'type'          THEN configuration.type END DESC,
  CASE WHEN $7::text = 'asc'  AND $8::text = 'section'       THEN configuration.section END ASC,
  CASE WHEN $7::text = 'desc' AND $8::text = 'section'       THEN configuration.section END DESC,
  CASE WHEN $7::text = 'asc'  AND $8::text = 'data'          THEN configuration.data END ASC,
  CASE WHEN $7::text = 'desc' AND $8::text = 'data'          THEN configuration.data END DESC,
  CASE WHEN $7::text = 'asc'  AND $8::text = 'meta'          THEN configuration.meta END ASC,
  CASE WHEN $7::text = 'desc' AND $8::text = 'meta'          THEN configuration.meta END DESC,
  CASE WHEN $7::text = 'asc'  AND $8::text = 'shared'        THEN configuration.shared END ASC,
  CASE WHEN $7::text = 'desc' AND $8::text = 'shared'        THEN configuration.shared END DESC,
  CASE WHEN $7::text = 'asc'  AND $8::text = 'status_ok'     THEN configuration.status_ok END ASC,
  CASE WHEN $7::text = 'desc' AND $8::text = 'status_ok'     THEN configuration.status_ok END DESC,
  CASE WHEN $7::text = 'asc'  AND $8::text = 'status_logs'   THEN configuration.status_logs END ASC NULLS LAST,
  CASE WHEN $7::text = 'desc' AND $8::text = 'status_logs'   THEN configuration.status_logs END DESC NULLS LAST,
  CASE WHEN $7::text = 'asc'  AND $8::text = 'source'        THEN configuration.source END ASC,
  CASE WHEN $7::text = 'desc' AND $8::text = 'source'        THEN configuration.source END DESC,
  CASE WHEN $7::text = 'asc'  AND $8::text = 'author_id'     THEN configuration.author_id END ASC NULLS LAST,
  CASE WHEN $7::text = 'desc' AND $8::text = 'author_id'     THEN configuration.author_id END DESC NULLS LAST,
  CASE WHEN $7::text = 'asc'  AND $8::text = 'created_at'    THEN configuration.created_at END ASC,
  CASE WHEN $7::text = 'desc' AND $8::text = 'created_at'    THEN configuration.created_at END DESC,
  CASE WHEN $7::text = 'asc'  AND $8::text = 'updated_at'    THEN configuration.updated_at END ASC NULLS LAST,
  CASE WHEN $7::text = 'desc' AND $8::text = 'updated_at'    THEN configuration.updated_at END DESC NULLS LAST,
