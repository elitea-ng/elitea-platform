...
func TestProductionRouterMatchesMainComposedRouteSurface(t *testing.T) {
	...
	want := []string{
		...
		"DELETE /api/v2/elitea_core/skill/{mode}/{projectID}/{skillID}/{versionID}",
		...
		"GET /api/v2/elitea_core/conversation_export/prompt_lib/{projectID}/{conversationID}",
		...
		"GET /api/v2/elitea_core/skill/{mode}/{projectID}/{skillID}/{versionID}",
		...
		"GET /api/v2/webhooks/prompt_lib/{projectID}/{webhookID}/deliveries",
		...
		"POST /api/v2/elitea_core/skill_version_restore/{mode}/{projectID}/{skillID}/{versionID}",
		...
		"POST /api/v2/webhooks/prompt_lib/{projectID}/{webhookID}/deliveries/{deliveryID}/redeliver",
		...
		"PUT /api/v2/elitea_core/skill/{mode}/{projectID}/{skillID}/{versionID}",
