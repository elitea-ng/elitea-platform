...
class WorkerCommandTypeV1(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    WORKER_COMMAND_TYPE_V1_TOOLKIT_EXECUTE_READ: _ClassVar[WorkerCommandTypeV1]
