...
class AgentExecutionInputV1(_message.Message):
    ...
    SUMMARY_MODEL_FIELD_NUMBER: _ClassVar[int]
    schema_revision: str
    llm: bytes
    chat_history: bytes
    user_input: bytes
