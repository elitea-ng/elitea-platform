/**
 * The LIVE confluence lane — ported from the legacy public suite's own
 ...
 * `LIVE_TOOLKIT_PROVIDERS.confluence.requiredEnv` is set — see
...
registerLiveToolkitJourneys(LIVE_TOOLKIT_PROVIDERS.confluence);
