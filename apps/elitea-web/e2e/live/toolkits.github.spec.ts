/**
 * The LIVE github lane — ported from the legacy public suite's own
 ...
 * `LIVE_TOOLKIT_PROVIDERS.github.requiredEnv` is set — see
...
registerLiveToolkitJourneys(LIVE_TOOLKIT_PROVIDERS.github);
