/**
 * The LIVE jira lane — ported from the legacy public suite's own
 ...
 * `LIVE_TOOLKIT_PROVIDERS.jira.requiredEnv` is set — see
...
registerLiveToolkitJourneys(LIVE_TOOLKIT_PROVIDERS.jira);
