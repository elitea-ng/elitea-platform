...
Open the admin console at `/admin/app/projects` and create a project. Project creation is administrator-only — Elitea has no self-service "request a project" flow; every project starts with an administrator creating it and assigning members afterward.
</Step>
