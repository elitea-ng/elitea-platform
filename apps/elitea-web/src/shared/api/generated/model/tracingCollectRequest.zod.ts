...
import { TracingTraceBatch } from "./tracingTraceBatch.zod";

export const TracingCollectRequest = zod
  .object({
...
export type TracingCollectRequestOutput = zod.output<
  typeof TracingCollectRequest
>;
