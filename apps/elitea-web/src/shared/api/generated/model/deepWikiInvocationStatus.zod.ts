...
export const DeepWikiInvocationStatus = zod
  .object({
    invocation_id: zod.string().optional(),
    status: zod.enum(["Started", "InProgress", "Completed", "Error"]),
    result: zod
      .string()
      .optional()
      .describe(
    ...
    custom_events: zod
      ...
      .optional()
      .describe(
        "Progress events accumulated since the previous poll. Read-once: a\ncaller that misses a poll does not see them again.\n",
      ),
  })
  .describe(
...
export type DeepWikiInvocationStatus = zod.input<
  typeof DeepWikiInvocationStatus
>;
export type DeepWikiInvocationStatusOutput = zod.output<
  typeof DeepWikiInvocationStatus
>;
