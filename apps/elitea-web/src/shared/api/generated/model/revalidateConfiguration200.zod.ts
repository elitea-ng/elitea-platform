...
export const RevalidateConfiguration200 = zod.object({
  ...
  status_ok: zod.boolean(),
  status_logs: zod.string().optional(),
...
export type RevalidateConfiguration200 = zod.input<
  typeof RevalidateConfiguration200
>;
export type RevalidateConfiguration200Output = zod.output<
  typeof RevalidateConfiguration200
>;
