...
import { MessageFeedback } from "./messageFeedback.zod";

export const MessageFeedbackSummary = zod
  .object({
    likes: zod.int(),
    dislikes: zod.int(),
...
export type MessageFeedbackSummaryOutput = zod.output<
  typeof MessageFeedbackSummary
>;
