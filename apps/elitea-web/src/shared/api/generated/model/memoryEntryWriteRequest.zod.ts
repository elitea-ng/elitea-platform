...
export const MemoryEntryWriteRequest = zod
  .object({
    content: zod.string(),
    tags: zod.array(zod.string()).optional(),
    source_conversation_id: zod.string().optional(),
    enabled: zod
      .boolean()
      .optional()
      .describe(
        "Defaults to `true` when omitted on create; on update it is a full-record field like the rest.",
      ),
  })
  .describe(
...
export type MemoryEntryWriteRequestOutput = zod.output<
  typeof MemoryEntryWriteRequest
>;
