...
export const ListApplicationsParams = zod.object({
  ...
  agents_type: zod.string().optional(),
});

export type ListApplicationsParams = zod.input<typeof ListApplicationsParams>;
export type ListApplicationsParamsOutput = zod.output<
  typeof ListApplicationsParams
>;
