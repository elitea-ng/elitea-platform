...
export const SkillIconDeleteRefusal = zod
  .object({
    ok: zod.boolean().describe("Always false on this body."),
    error: zod.string(),
  })
  .describe(
...
export type SkillIconDeleteRefusalOutput = zod.output<
  typeof SkillIconDeleteRefusal
>;
