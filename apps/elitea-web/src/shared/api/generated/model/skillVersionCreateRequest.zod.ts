...
export const SkillVersionCreateRequest = zod
  .object({
    name: zod
      .string()
      .describe(
    ...
    instructions: zod
      ...
      .optional()
      .describe(
        "When omitted (or empty), the new version clones source_version_id's content instead of being created empty.",
      ),
...
export type SkillVersionCreateRequest = zod.input<
  typeof SkillVersionCreateRequest
>;
export type SkillVersionCreateRequestOutput = zod.output<
  typeof SkillVersionCreateRequest
>;
