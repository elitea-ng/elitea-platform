...
export const AdminSecretUpdateRequest = zod
  .object({
    secret: zod.object({
      old_name: zod.string().optional(),
      value: zod.string(),
    }),
  })
  .describe(
...
export type AdminSecretUpdateRequest = zod.input<
  typeof AdminSecretUpdateRequest
>;
export type AdminSecretUpdateRequestOutput = zod.output<
  typeof AdminSecretUpdateRequest
>;
