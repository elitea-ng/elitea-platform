...
export const SecretListItem = zod
  .object({
    name: zod
      .string()
      .describe("The secret's canonical name (the vault map key)."),
    secret_name: zod
      .string()
      .describe("The `{{secret.<name>}}` placeholder, for display."),
    is_default: zod
      .boolean()
      .describe(
...
export type SecretListItemOutput = zod.output<typeof SecretListItem>;
