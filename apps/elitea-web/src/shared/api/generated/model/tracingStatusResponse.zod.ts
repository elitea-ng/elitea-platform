...
export const TracingStatusResponse = zod
  .object({
    enabled: zod
      .boolean()
      .describe(
    ...
    project_id: zod
      .string()
      .optional()
      .describe("Echoed back on the prompt_lib (project-scoped) read."),
    config: zod
      .object({
        collector_endpoint: zod.string().optional(),
...
export type TracingStatusResponseOutput = zod.output<
  typeof TracingStatusResponse
>;
