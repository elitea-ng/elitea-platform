...
import { ToolkitTool } from "./toolkitTool.zod";

export const ToolkitToolsPayload = zod
  .object({
    tools: zod.array(ToolkitTool),
    total: zod.int(),
  })
  .describe(
...
export type ToolkitToolsPayloadOutput = zod.output<typeof ToolkitToolsPayload>;
