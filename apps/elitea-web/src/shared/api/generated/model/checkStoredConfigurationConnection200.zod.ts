...
export const CheckStoredConfigurationConnection200 = zod.object({
  success: zod.boolean().describe("Always true on this response."),
  message: zod.string(),
  reason: zod
...
export type CheckStoredConfigurationConnection200 = zod.input<
  typeof CheckStoredConfigurationConnection200
>;
export type CheckStoredConfigurationConnection200Output = zod.output<
  typeof CheckStoredConfigurationConnection200
>;
