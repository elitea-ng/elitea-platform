...
export const ApplicationRelationUpdatedResponse = zod
  .object({
    application_id: zod
      .string()
      .describe("Echo of the {selected_application_id} path segment."),
    version_id: zod
      .string()
...
>;
export type ApplicationRelationUpdatedResponseOutput = zod.output<
  typeof ApplicationRelationUpdatedResponse
>;
