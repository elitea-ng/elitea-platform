...
export const ApplicationRelationUpdateRequest = zod
  .object({
    application_id: zod.union([zod.string(), zod.int()]).optional(),
    version_id: zod.union([zod.string(), zod.int()]).optional(),
...
export type ApplicationRelationUpdateRequest = zod.input<
  typeof ApplicationRelationUpdateRequest
>;
export type ApplicationRelationUpdateRequestOutput = zod.output<
  typeof ApplicationRelationUpdateRequest
>;
