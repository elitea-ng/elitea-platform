...
import { ForkApplicationInput } from "./forkApplicationInput.zod";
import { SkillForkInput } from "./skillForkInput.zod";

export const ForkRequest = zod
  .object({
    applications: zod
...
export type ForkRequestOutput = zod.output<typeof ForkRequest>;
