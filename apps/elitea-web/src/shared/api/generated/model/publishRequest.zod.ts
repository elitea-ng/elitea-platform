...
export const publishRequestVersionNameRegExp = new RegExp("^[a-zA-Z0-9._-]+$");

export const PublishRequest = zod
  .object({
    version_name: zod.string().regex(publishRequestVersionNameRegExp),
...
export type PublishRequestOutput = zod.output<typeof PublishRequest>;
