...
import { ImportEntity } from "./importEntity.zod";

export const ImportWizardRequest = zod
  .union([
    zod.array(ImportEntity),
    zod.object({
      applications: zod.array(ImportEntity),
    }),
  ])
  .describe(
...
export type ImportWizardRequestOutput = zod.output<typeof ImportWizardRequest>;
