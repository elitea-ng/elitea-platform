...
export const SystemInfoComponent = zod.object({
  name: zod
    .string()
    .describe(
...
export type SystemInfoComponent = zod.input<typeof SystemInfoComponent>;
export type SystemInfoComponentOutput = zod.output<typeof SystemInfoComponent>;
