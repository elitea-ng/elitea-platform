...
import { EvalRun } from "./evalRun.zod";
import { EvalRunResult } from "./evalRunResult.zod";

export const EvalScorecard = zod
  .object({
    run: EvalRun,
    results: zod.array(EvalRunResult),
    headline_score: zod.number().nullable(),
    total: zod.int(),
    offset: zod.int(),
...
export type EvalScorecardOutput = zod.output<typeof EvalScorecard>;
